export const initialRecords = [
  ...
  { id: 3, name: "Vacation", account: "Credit Card", amount: -25.56, date: "2026-05-10", icon: "briefcase", tone: "var(--orange)" },
  { id: 4, name: "Food", account: "Cash", amount: -45.3, date: "2026-05-12", icon: "bag", tone: "var(--orange)" },
  { id: 5, name: "Transport", account: "Debit Card", amount: -12.8, date: "2026-05-08", icon: "card", tone: "var(--blue)" },
];

export const screenNames = new Set(["onboarding", "home", "records", "budgets", "add-budget", "stats", "cards", "categories", "add-category", "edit-category", "icon-picker", "settings", "add", "add-card", "edit-card", "menu"]);
