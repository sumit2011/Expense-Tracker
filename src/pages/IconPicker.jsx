...
const allIcons = [
  ...
  { name: "car", label: "Car" },
  { name: "bus", label: "Bus" },
  { name: "heartLightning", label: "Favorite" },
  { name: "smiley", label: "Happy" },
  { name: "dollarBox", label: "Money" },
  { name: "building", label: "Office" },
  { name: "calendar", label: "Calendar" },
  { name: "document", label: "Document" },
  { name: "cash", label: "Income" },
  { name: "briefcase", label: "Work" },
  { name: "card", label: "Transport" },
  { name: "shield", label: "Health" },
  { name: "heart", label: "Life" },
  { name: "spark", label: "Event" },
