...
export default function Onboarding({ start }) {
  return (
    <section className="screen no-nav onboarding">
      ...
      <div className="happy"><strong>2k</strong><span>HAPPY USERS</span><p style={{ color: "var(--yellow)", fontSize: 22, margin: "12px 0" }}>*****</p></div>
      <button className="primary-action center" onClick={start}>Start Tracking</button>
